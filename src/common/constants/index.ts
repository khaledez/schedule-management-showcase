...
export const CLINIC_SETTINGS_REPOSITORY = 'CLINIC_SETTINGS_REPOSITORY';
export const APPOINTMENT_CRON_JOB_REPOSITORY = 'APPOINTMENT_CRON_JOB_REPOSITORY';
...
export const EVENT_APPOINTMENT_REMINDER = 'APPOINTMENT_REMINDER';
export const EVENT_APPOINTMENT_CONFIRMATION_REQUIRED = 'APPOINTMENT_CONFIRMATION_REQUIRED';
export const EVENT_APPOINTMENT_APPOINTMENT_CHECKIN = 'APPOINTMENT_CHECKIN';
