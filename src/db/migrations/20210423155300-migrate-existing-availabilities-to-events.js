...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.sequelize
      .query(`INSERT INTO Events (staff_id, clinic_id, appointment_id, availability_id, date, end_date, duration_minutes, start_time, created_at, created_by, updated_at, updated_by, deleted_at, deleted_by)
